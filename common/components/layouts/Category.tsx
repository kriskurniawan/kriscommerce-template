export default function Category() {
    return (
        <div className="container mx-auto">
            <div className="flex pt-10 justify-center items-center relative">
                <div className="w-9 h-9 bg-gray-200 rounded-full flex cursor-pointer absolute left-36 hover:bg-amber-400">
                ...
                <div className="w-9 h-9 bg-gray-200 rounded-full flex cursor-pointer absolute right-36 hover:bg-amber-400">
                    <div className="m-auto">
                        <div className="w-6 h-6">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
