...
const Navigation = () => {
    return (
        <div className="w-full h-16 bg-zinc-100 flex flex-wrap sticky top-16 z-50">
            ...
            {/* <Link href="/categories">
                <div className="ml-16 w-52 h-16 bg-amber-500 justify-center items-center gap-4 flex p-auto">
                    <div className="text-white text-base font-medium">Browse categories</div>
                ...
                <div className="ml-5 justify-center items-center gap-7 flex">
                    <Link href="/">
                        <div className="justify-center items-center gap-4 flex hover:bg-amber-500">
                            <div className="text-neutral-700 text-base font-medium">Home</div>
                            <div className="w-6 h-6 justify-center items-center flex">
                                <div className="w-6 h-6 relative">
                    ...
                    <div className="justify-center items-center gap-4 flex">
                        <div className="text-neutral-700 text-base font-medium">Catalog</div>
                        <div className="w-6 h-6 justify-center items-center flex">
                            <div className="w-6 h-6 relative">
                                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M19.92 9.45001L13.4 15.97C12.63 16.74 11.37 16.74 10.6 15.97L4.08002 9.45001" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                    ...
                    <div className="justify-center items-center gap-4 flex">
                        <div className="text-neutral-700 text-base font-medium">Blog</div>
                    </div>
                    <div className="justify-center items-center gap-4 flex">
                        <div className="text-neutral-700 text-base font-medium">Pages</div>
                        <div className="w-6 h-6 justify-center items-center flex">
                            <div className="w-6 h-6 relative">
                                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="justify-center items-center gap-4 flex">
                        <div className="text-neutral-700 text-base font-medium">About us</div>
                    </div>
                </div>
                <div className="text-sky-900 text-base font-bold mr-16">30 Days Free Return</div>
            </div> */}
        </div>
    )
}
