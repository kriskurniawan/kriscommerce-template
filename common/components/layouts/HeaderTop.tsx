        ...
        <div className="justify-between flex p-5 m-auto">
            ...
            <div className="justify-center items-center gap-9 flex">
                    ...
                    <div className="w-6 h-6 justify-center items-center flex">
                        <div className="w-6 h-6 relative">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M3.62 8.49C5.59 -0.169998 18.42 -0.159997 20.38 8.5C21.53 13.58 18.37 17.88 15.6 20.54C13.59 22.48 10.41 22.48 8.39 20.54C5.63 17.88 2.47 13.57 3.62 8.49Z" stroke="#292D32" stroke-width="1.5" />
                            </svg>
                        </div>
                    </div>
                ...
                <div className="justify-center items-center gap-5 flex">
                    ...
                    <div className="text-zinc-800 text-sm font-normal font-['Poppins']">Track your order</div>
                </div>
            </div>
        </div>
    )
